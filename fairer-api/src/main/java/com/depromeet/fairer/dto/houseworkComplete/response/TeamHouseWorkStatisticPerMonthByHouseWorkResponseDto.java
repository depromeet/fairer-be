...
public class TeamHouseWorkStatisticPerMonthByHouseWorkResponseDto {

    @ApiModelProperty(value = "멤버 별 집안일 완료 통계 객체 리스트")
    private List<MemberHouseWorkStatisticByHouseWorkDto> houseWorkStatics;

    public static TeamHouseWorkStatisticPerMonthByHouseWorkResponseDto of(
            List<MemberHouseWorkStatisticByHouseWorkDto> houseWorkStatics
    ) {
        return new TeamHouseWorkStatisticPerMonthByHouseWorkResponseDto(houseWorkStatics);
    }
}
